...
interface PythGovernanceInterface extends ethers.utils.Interface {
  functions: {
    ...
    "pyth2WormholeEmitter()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "pyth2WormholeEmitter",
    values?: undefined
  ): string;
...
export class PythGovernance extends BaseContract {
  ...
  interface: PythGovernanceInterface;
  ...
  functions: {
    ...
    pyth2WormholeEmitter(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    pyth2WormholeEmitter(overrides?: CallOverrides): Promise<BigNumber>;
